...
import { drawThingsDefaultSampler } from './drawThings';
...
const defaultDrawThingsSamplerPair: [string, string] = [drawThingsDefaultSampler, drawThingsDefaultSampler];
...
export const modelArchs: ModelArch[] = [
  {
    ...
    defaults: {
      ...
      'config.process[0].sample.sampler': defaultDrawThingsSamplerPair,
